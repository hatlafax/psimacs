...
[[https://www.gnu.org/software/emacs/][https://img.shields.io/badge/GNU%20Emacs-29.1-green.svg?style=plastic]]
...
*Attention:*
- At least 22 GByte of free disk space is used by the installation!
- Performing a *Psimacs* bootstrapping operation is at one's own risk.

*Remark:* Windows Powershell typically restricts the execution of scripts. You have to
